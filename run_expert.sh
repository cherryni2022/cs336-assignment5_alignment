...
python cs336_alignment/my_async_train_expert_iter.py --use_correct $use_correct --train_samples $train_samples --train_batch_size $train_batch_size --micro_batch_size $micro_batch_size --n_sft_steps $n_sft_steps > sft_s${train_samples}_b${train_batch_size}_lr2e-5_${current_time}.log 2>&1 &
