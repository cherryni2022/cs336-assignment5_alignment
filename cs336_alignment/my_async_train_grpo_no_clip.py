...
class TrainConfig:
    ...
    # type:no_baseline,reinforce_with_baseline,grpo_clip,grpo_no_clip
    loss_type: str = "grpo_no_clip"
        ...
        for train_microstep in range(train_config.gradient_accumulation_steps):
            ...
            if train_microstep == train_config.gradient_accumulation_steps - 1:
                ...
                wandb.log({
                        ...
                        "train/response_entropy": to_float(entropy[response_mask_micro].mean()),
                        ...
                        # "train/prompt_entropy": to_float(entropy[~response_mask_micro].mean()),
